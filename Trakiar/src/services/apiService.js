...
export const searchRoutes = async (token, query, location = null) => {
  const params = {
    q: query,
    puntoClave: query,
  };
  ...
  if (
    ...
    params.latitudUsuario = location.latitud;
    params.longitudUsuario = location.longitud;
  }
